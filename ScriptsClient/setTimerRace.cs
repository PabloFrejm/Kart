...
public class setTimerRace : MonoBehaviour
{

    public TextMeshProUGUI textTimeGame, textTimeStartGame, textTimeStartRank;
    ...
    void Update()
    {
         ...
         textTimeStartRank.text = TimeSpan.FromSeconds(currentTime).ToString(@"h\:mm\:ss");
    ...
    public void ActEndTime()
    {
        ...
        GetCommand.SendCommandStopRace();
